        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3 w-full px-4">
          {isCompleted && (
            <>
              ...
              <motion.button
                id="btn-shaday-replay-formation"
                type="button"
                ...
                className="inline-flex items-center justify-center p-3.5 rounded-full bg-[#18181B]/90 hover:bg-[#27272A] border border-white/20 text-[#F87171] shadow-[0_0_20px_rgba(0,0,0,0.5)] backdrop-blur-md transition-all cursor-pointer"
              >
              ...
              <SaveFlowerButton
                userName="Shaday"
                stageContainerId="shaday-bouquet-container"
                animationDurationMs={12100}
